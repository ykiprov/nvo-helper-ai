...
-- material_files
DROP POLICY IF EXISTS "Anyone can read material files ref" ON public.material_files;
DROP POLICY IF EXISTS "Teachers can insert material files ref" ON public.material_files;
DROP POLICY IF EXISTS "Teachers can delete material files ref" ON public.material_files;
...
DROP POLICY IF EXISTS "Anyone can read own test attempts" ON public.test_attempts;
